...
@Component({
                    ...
                    <div class="area-item" *ngFor="let area of codeAreas(); let i = index">
                      ...
                      <div class="area-bottom-row">
                        <div class="font-control">
                          ...
                          <input type="number" [(ngModel)]="area.fontSize" min="4" max="72" class="admin-input font-input">
                        </div>
                    ...
                    <div class="areas-list" *ngIf="vigenciaAreas().length > 0">
                      <div class="area-item vigencia-item" *ngFor="let area of vigenciaAreas(); let idx = index">
                        ...
                        <div class="area-bottom-row">
                          <div class="font-control">
                            <label>TAMAÑO FUENTE:</label>
                            <input type="number" [ngModel]="area.fontSize" (ngModelChange)="updateVigenciaFontSize(idx, $event)" min="4" max="72" class="admin-input font-input">
                          </div>
  ...
  styles: [`
    ...
    .vigencia-area-box { border-color: #d97706; background: rgba(217, 119, 6, 0.15); }
    .vigencia-area-box .demo-text { color: #d97706; }
    .vigencia-item { border-left-color: #d97706; }
...
export class AdminRewardFormComponent implements OnInit, AfterViewInit {
  ...
  vigDragStartScrollX = 0; vigDragStartScrollY = 0;
  ...
  updateVigenciaDragPosition(e: MouseEvent) {
    const container = this.pdfPreviewWrapper?.nativeElement;
    const dScrollX = container ? (container.scrollLeft - this.vigDragStartScrollX) : 0;
  ...
  startDragVigencia(e: MouseEvent, index: number) {
    ...
    if (this.pdfPreviewWrapper) {
      const container = this.pdfPreviewWrapper.nativeElement;
      this.vigDragStartScrollX = container.scrollLeft; this.vigDragStartScrollY = container.scrollTop;
    }
  }
